...
export default function AdminDocumentsPage() {
  ...
  return (
    <div className="space-y-6 relative min-h-screen pb-12 font-mono">
      ...
      {/* ============================================================================ */}
      {toast.visible && (
        <div className="fixed bottom-6 right-6 z-50 flex items-center gap-2.5 px-4 py-3 rounded-lg border border-[#00FFC2]/30 bg-[#050505]/95 text-[#00FFC2] font-mono text-xs shadow-[0_0_20px_rgba(0,255,194,0.15)] animate-in fade-in slide-in-from-bottom-4 duration-300 select-none">
