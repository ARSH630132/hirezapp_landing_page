    ...
    >
      <div className="relative z-10 w-full lg:w-[48%] xl:w-[46%] shrink-0 flex flex-col justify-start px-6 lg:pl-16 lg:pr-4 pt-10 lg:pt-14 pb-16 lg:pb-20">
        <h1 className="relative z-20 w-[115%] max-w-[760px] text-[40px] sm:text-[48px] lg:text-[52px] leading-[1.1] font-semibold">
          ...
          <span
            ...
            style={{
              backgroundImage: "linear-gradient(90deg, #E4000F 0%, #009DFF 100%)",
            }}
          >
            AI-Native
          </span>{" "}
        ...
        <p className="mt-5 text-[15px] sm:text-[16px] lg:text-[18px] leading-[1.65] font-medium text-gray-300">
          Combining Agentic AI, Knowledge Graphs, Industry Platforms, Talent
          Cloud, and Managed AI Operations into a single transformation
          ecosystem.
        </p>
        ...
        <div className="mt-10 lg:mt-12 flex flex-col sm:flex-row flex-wrap gap-4 w-full">
          ...
          >
            <span className="text-white text-[16px] leading-none font-semibold whitespace-nowrap">
          ...
          >
            <span className="text-white text-[16px] leading-none font-medium whitespace-nowrap">
              Experience GFF AI Live
            </span>
          </Link>
        </div>
        ...
        <div className="mt-12 pt-8 border-t border-white/10 grid grid-cols-2 lg:grid-cols-3 gap-4">
          <div className="flex flex-col">
            ...
            <span className="text-xs text-gray-400">AI Use Cases</span>
          </div>
          ...
          <div className="flex flex-col">
            ...
            <span className="text-xs text-gray-400">Live Agent Counter</span>
          </div>

          <div className="flex flex-col">
            <span className="text-2xl font-bold text-white">100+</span>
            <span className="text-xs text-gray-400">Live Projects</span>
          </div>
          ...
          <div className="flex flex-col">
            <span className="text-lg font-bold text-white mt-1">AI Academy</span>
            <span className="text-xs text-gray-400">Talent Cloud</span>
          </div>
        </div>
      </div>
      ...
      <div className="flex-1 relative h-auto lg:min-h-0 overflow-hidden">
        ...
        <div
          ...
          style={{
            background:
              "linear-gradient(90deg, #000000 0%, rgba(0,0,0,0.45) 18%, rgba(0,0,0,0) 50%)",
          }}
        />
      </div>
    </motion.section>
