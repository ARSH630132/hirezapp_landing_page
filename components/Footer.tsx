...
const socialLinks = [
  ...
  { name: "LinkedIn", h: "#", icon: "/footer/linkedin.png" },
  { name: "Twitter", h: "#", icon: "/footer/twitter.png" },
  { name: "Email", h: "mailto:contact@gff.ai", icon: "/footer/mail.png" },
  { name: "YouTube", h: "#", icon: "/footer/youtube.png" },
  { name: "Instagram", h: "#", icon: "/footer/instagram.png" },
];
...
<div className="grid grid-cols-[max-content_max-content_max-content_max-content_max-content_max-content_250px] gap-x-10 gap-y-10">  {footerCols.map((col) => (
