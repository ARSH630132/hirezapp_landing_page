...
export const CATS: ResourceCategory[] = [
  ...
  { t: "Developer Documentation", s: "developer-docs", m: "Tech", tg: "DEVELOPER RESOURCES", d: "Robust API references, schema declarations, and SDK manuals for orchestrating secure agentic clusters.", h: "/resources/developer-docs" },
